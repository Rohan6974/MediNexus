  ...
  return (
    ...
    <div className='flex flex-col items-center justify-center mb-8 text-center'>
        ...
        <p className='text-muted-foreground text-lg'>
            Browse through our list of <span className='bg-gradient-to-b from-emerald-500 to-teal-400 text-transparent bg-clip-text'>specialties</span> to find the right <span className='bg-gradient-to-b from-emerald-500 to-teal-400 text-transparent bg-clip-text'>doctor</span> for your needs.
        </p>
    </div>
